...
<template>
    <div class="hidden lg:flex items-center justify-center ml-8">
        <button @click='toLightMode' title="Switch to light mode" class="relative w-10 h-10 focus:outline-none focus:shadow-outline text-gray-500">
        ...
        <button @click="toDarkMode" title="Switch to dark mode" class="relative w-10 h-10 focus:outline-none focus:shadow-outline text-gray-500">
